...
if __name__ == "__main__":
    ...
    parser.add_argument("-f", "--format", dest="format", default="%artist% - %title% - %album%", help="Same formats that 'mpc' uses.")
    parser.add_argument("-c", "--color", dest="color", default="#f0c674", help="Color of the returned text. Default: #f0c674")
